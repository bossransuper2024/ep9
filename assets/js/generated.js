...
(function () {
  ...
  "combat": {
    ...
    "liveEvent": {
      ...
      "schedule": "Schedule: Everyday 10AM, 1PM, 4PM, 7PM, 10PM and 1AM"
    },
    "modes": [
      {
        "n": "TYRANNY WARS",
        "t": "All-out guild war",
        "cap": "100v100",
        "schedule": "Everyday 10AM, 1PM, 4PM, 7PM, 10PM and 1AM",
        "hot": true
      },
      {
        "n": "CAPTURE THE FLAG",
    ...
    "raids": [
      {
        "n": "FORBIDDEN TOWER",
        "t": "Vertical raid — 30 floors",
        "limit": "2 raids limit per day"
      },
      {
        "n": "OUTER WALL",
        "t": "Open-field gauntlet — 5 floors",
        "limit": "1 raid limit per day"
      }
    ]
  },
  "roadmap": {
    ...
    "mirrors": [
      {
        ...
        "url": "https://drive.google.com/file/d/1umtckbzvUtoaV35ZgKHmkxM_Nj2y7WHS/view?usp=sharing",
        "note": "English full client"
      },
      {
        "label": "Google Drive (TW)",
        "url": "https://drive.google.com/file/d/1MBZwUIqPDuqGw52BMw4VOvRT5ZlqZfdM/view?usp=sharing",
        "note": "Chinese full client"
      },
      {
        "label": "MediaFire (EN)",
        "url": "https://www.mediafire.com/file/pkvy337fjxrv3pd/Ran+GS+Eternity+EN.exe/file",
        "note": "English full client"
      },
      {
        "label": "MediaFire (TW)",
        "url": "https://www.mediafire.com/file/xlnc58fj0lmuqjb/Ran+GS+Eternity+TW.exe/file",
        "note": "Chinese full client"
      }
    ],
    "discordUrl": "https://www.facebook.com/ranonlineix",
  ...
  "services": {
    "title": "OUR",
    "accent": "SERVICES.",
    "intro": "Run by players, for players — every service below is staff-verified and backed by the RAN GS Eternity team.",
    "apply": {
  ...
  "footer": {
    "tagline": "Students calls. Answer it.",
    "columns": [
      {
        "title": "SERVER",
        "links": [
      ...
      },
      {
        ...
        "links": [
          {
            "label": "Bug Reports",
            "href": "https://discord.gg/eternity"
          },
          {
            "label": "Contact",
            "href": "https://www.facebook.com/ranonlineix"
