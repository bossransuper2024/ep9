...
(function () {
  ...
  /* ---- SERVICES ---- (rows come from per-category CSV databases: pilot.csv / middleman.csv / streamer.csv) */
  ...
  function Services() {
    ...
    return e("section", { id: "services", style: { position: "relative", padding: "120px 48px", borderTop: "1px solid rgba(255,255,255,.06)", overflow: "hidden" } },
      e("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(180deg, var(--bg) 0%, rgba(20,30,60,.55) 50%, var(--bg) 100%)" } }),
      e("div", { style: { position: "relative", maxWidth: 1280, margin: "0 auto" } },
        e("div", { style: { marginBottom: 50 } },
