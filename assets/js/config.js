...
(function () {
  var defaults = {
    ...
    nav: ["Home", "Server", "Classes", "Combat", "Roadmap", "Download", "Community", "Services"],
    background: {
    ...
    news: {
      ...
      title: "THE LATEST",
      accent: "NEWS.",
      intro: "Announcements, patch notes and community tutorials — straight from the RAN GS Eternity team.",
      tabAnnouncement: "Announcement",
      tabEvent: "Event",
      announcement: [
        { date: "August 20, 2026", title: "Open Beta", image: "", link: "#", description: "Open Beta is now available." },
        { date: "September 1, 2026", title: "Patch Notes v1.1", image: "", link: "#", description: "What changed in this patch." }
      ],
      event: [
        { date: "September 10, 2026", title: "Community Event: Tyranny Wars", image: "", link: "#", description: "Guilds clash for territory and supremacy." },
        { date: "September 15, 2026", title: "Double EXP Weekend", image: "", link: "#", description: "Earn double EXP across all maps this weekend." },
        { date: "September 20, 2026", title: "Founding Member Giveaway", image: "", link: "#", description: "Founder cosmetics and starter gear for the first 500 players." }
      ]
    },
    services: {
